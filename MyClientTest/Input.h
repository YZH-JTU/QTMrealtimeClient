...
public:
    ...
    bool ReadDataComponents(unsigned int &nComponentType, char* selectedAnalogChannels, int selectedAnalogChannelsLen);
    unsigned int ReadDataComponent(bool bMultiple);
    ...
    void ReadCameraSettings(unsigned int &nCameraId,       int   &nMode,            int   &nVideoMode,
